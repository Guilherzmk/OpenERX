...
namespace OpenERX.Core.Customers
{
    ...
    {
        Task<CustomerResult> CreateAsync(CustomerParams createParams, Guid profileId, Credential credential);
        Task<CustomerResult> UpdateAsync(Guid id, CustomerParams updateParams, Guid profileId, Credential credential);
